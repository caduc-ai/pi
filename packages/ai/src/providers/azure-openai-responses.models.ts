...
export const AZURE_OPENAI_RESPONSES_MODELS: ModelCatalog<typeof modelGroups, "azure-openai-responses"> =
	flattenModelCatalog("azure-openai-responses", modelGroups);
