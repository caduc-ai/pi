...
export interface Config {
	...
	provider?: {
		...
		// HTTP(S) proxy URL to pass to Claude Code. Claude Code does not support SOCKS URLs
		// in HTTP_PROXY/HTTPS_PROXY; use an HTTP CONNECT proxy in front of SOCKS when needed.
		httpProxy?: string;
